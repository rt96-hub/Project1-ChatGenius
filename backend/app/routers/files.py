...
async def upload_file(
    ...
    try:
        ...
        await events.broadcast_file_upload(message.channel_id, file_upload, message)
...
async def delete_file(
    ...
    try:
        ...
        await events.broadcast_file_deleted(message.channel_id, file_id, file_upload.message_id)
